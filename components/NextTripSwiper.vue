  ...
  <section class="mt-20  dir-rtl">
    <div class="flex flex-col sm:flex-row gap-4 sm:gap-8 mr-8 sm:mr-16 md:mr-32 lg:mr-44 xl:mr-56 2xl:mr-64">
      ...
      <p class="text-gray-500 sm:w-2/5 sm:mt-10">
        نمی دانید در سفر بعدی خود به کجا بروید یا چه کاری انجام دهید؟ جای نگرانی نیست ما منتخبی از سفرهای انتخاب شده از
        نقاط
        مختلف کشور را جمع آوری کرده ایم. مناظر جالب برای دیدن، مکان‌هایی برای بازدید و رستوران‌هایی برای صرف غذا پیدا
        کنید.
      </p>
        ...
        <div
          ...
          <div class="relative">
            <div class=" w-full sm:h-[35rem]">
              <img v-show="index<10" :src="slide.img" alt="swiper"
            ...
            <div class="absolute  bottom-16 right-4 ">
              <div class="flex flex-col">
                <p class="text-white text-3xl font-bold  ">{{ slide.title }}</p>
              </div>
            </div>
            <div>
              <div
...
const items = reactive([
  {
    id: 31,
    isSaved: false,
    img: 'http://localhost:3000/_nuxt/static/swiper.jpg',
    title: 'زیر شفق قطبی بخوابید',
