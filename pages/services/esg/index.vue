                      ...
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          ...
                          <p class="mt-2 text-gray-600">
                            Structured engagement and training reduce the typical 6–12-month adoption curve by up to 40%.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          ...
                          <p class="mt-2 text-gray-600">
                            Early identification and mitigation of resistance prevent productivity dips and costly rework.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          ...
                          <p class="mt-2 text-gray-600">
                            Defined KPIs (e.g., user adoption rates, time-to-competency) tie change efforts directly to business outcomes.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="space-y-4">
                    <div
                      ...
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Enhanced Employee Engagement</h4>
                          <p class="mt-2 text-gray-600">
                            Organizations report up to a 25% increase in engagement scores when leadership visibly supports change.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Leadership Pipeline Strength</h4>
                          <p class="mt-2 text-gray-600">
                            A structured development program reduces external hiring needs by promoting internal talent.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Sustainable Culture Shift</h4>
                          <p class="mt-2 text-gray-600">
                            Embedding cultural changes at all levels mitigates risk of regression when key sponsors rotate.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="space-y-4">
                    <div
                      ...
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Faster Time-to-Competency</h4>
                          <p class="mt-2 text-gray-600">
                            Targeted programs can cut ramp-up time by 30–50%, accelerating project delivery.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Reduced Skill Gaps</h4>
                          <p class="mt-2 text-gray-600">
                            Proactive upskilling minimizes reliance on external contractors and agencies.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Retention & Morale</h4>
                          <p class="mt-2 text-gray-600">
                            Clear development pathways increase employee loyalty and reduce turnover.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="space-y-4">
                    <div
                      ...
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Increased Flexibility</h4>
                          <p class="mt-2 text-gray-600">
                            Teams can pivot within weeks, not quarters, to seize new opportunities or mitigate risks.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Cost Efficiency</h4>
                          <p class="mt-2 text-gray-600">
                            Leaner processes and fewer handoffs reduce waste, cutting operational costs by up to 20%.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 hover:border-indigo-200 transition-all hover:shadow-sm group">
                      <div class="flex items-start">
                        ...
                        <div class="ml-4">
                          <h4 class="font-medium text-gray-900 group-hover:text-primary transition-colors">Enhanced Innovation</h4>
                          <p class="mt-2 text-gray-600">
                            A modular operating model accelerates the launch of new products and services.
                          </p>
                        </div>
                      </div>
                    </div>
